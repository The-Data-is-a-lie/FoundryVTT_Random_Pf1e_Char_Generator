...
#
# packs/ USED to be 2.5 MB of dead LevelDB from the removed spell-conditionals compendium, excluded
# here because module.json declared "packs": [] and none of it was distributed. No longer true: the
# feat compendium is declared in module.json and MUST ship, so `packs` is gone from /XD below. The
